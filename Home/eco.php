...
$query = mysqli_query($db, "SELECT * FROM articulos WHERE categoria = 'economia'");    
...
<body>
    ...
    <div class="container text-center" style="margin-top: 250px;">
      <h2 style="margin-bottom: 50px;">Economía</h2>  
    </div>
...
<?php
            ...
            <div id="cont" class="contenedor-flex text-center" style="width: 50%; margin: 0 auto;">
                ...
                <div class="cuerpo">
                    ...
                    <p class="desc"><?php echo 'Autor: ' . $row['autor']; ?></p>
                    <p class="cate"><?php echo 'Categoría: ' . $row['categoria']; ?></p>
